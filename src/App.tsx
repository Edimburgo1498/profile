      ...
      <div className="justify">
        <section className="article-1">
          <div className="wrap" ref={wrap}>
            ...
            <div className="icons">
              <p>
                <i className="fa fa-envelope-o" id="mail" aria-hidden="true"></i>
              </p>
              <p>
              ...
              <p>
                <i className="fa fa-linkedin-square" id="square" aria-hidden="true"></i>
              </p>
            </div>
          </div>
...
            desarrollo de nuevas funcionalidades para distintos sistemas,
            responsable del mantenimiento de las bases de datos y las
            constantes actualizaciones que se requerían,  seguridad de lo
            Sistemas y lógica de negocio.
            <h5 style={{marginTop: '3%'}}>Cti - Soporte TI soporte</h5>
            + creación de reportes de errores y fallos, implementación de correcciones.
            + capacidad para solucionar problemas operativos vía remota.
            + mantenimiento de sistemas para garantizar el correcto funcionamiento.
          </p>
        </section>
        ...
        <section className="article-5">
          ...
          <div className="grid-container" >
            <div style={{ height: "15vh", width: "180px" }}>
